...
public class RDFUtil {
	...
	public static char[] decode(char[] in) {
		...
		for (char caractere_lu : in) {
			...
			if (pos == -1) {
				System.err.println("Column " + col + ": The value " + String.format("%04x", (short) caractere_lu) + "  can't be find.\n");
				err++;
			}
			col++;
			if (col > 7) {
